...
public void syntax_error(Symbol s){ 
 ...
 Error_encontrado error_sintactico = new Error_encontrado("Archivo configuración",s.value.toString(), "", s.left, s.right+1, true);
  ...
  public final java_cup.runtime.Symbol CUP$Sintactico_configuracion$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Sintactico_configuracion$act_num)
          ...
          case 4: // CONFIGURACION ::= abrir_tag r_fondo cerrar_tag CONFIGURACION_FONDO abrir_tag s_guion r_fondo cerrar_tag abrir_tag r_disenio cerrar_tag DECLARAR_ATRIBUTOS abrir_tag s_guion r_disenio cerrar_tag abrir_tag r_figura cerrar_tag DECLARAR_ATRIBUTOS abrir_tag s_guion r_figura cerrar_tag 
            {
              ...
              CUP$Sintactico_configuracion$result = parser.getSymbolFactory().newSymbol("CONFIGURACION",2, ((java_cup.runtime.Symbol)CUP$Sintactico_configuracion$stack.elementAt(CUP$Sintactico_configuracion$top-23)), ((java_cup.runtime.Symbol)CUP$Sintactico_configuracion$stack.peek()), RESULT);
            }
          return CUP$Sintactico_configuracion$result;
		...
		Objeto a = (Objeto)((java_cup.runtime.Symbol) CUP$Sintactico_configuracion$stack.peek()).value;
		a.setNombre(n.toString()); RESULT = a;
          ...
          case 19: // ATRIBUTOS ::= ATRIBUTO_VIDA ATRIBUTOS 
            {
              Object RESULT =null;
		int vleft = ((java_cup.runtime.Symbol)CUP$Sintactico_configuracion$stack.elementAt(CUP$Sintactico_configuracion$top-1)).left;
		int vright = ((java_cup.runtime.Symbol)CUP$Sintactico_configuracion$stack.elementAt(CUP$Sintactico_configuracion$top-1)).right;
		Object v = (Object)((java_cup.runtime.Symbol) CUP$Sintactico_configuracion$stack.elementAt(CUP$Sintactico_configuracion$top-1)).value;
		int aleft = ((java_cup.runtime.Symbol)CUP$Sintactico_configuracion$stack.peek()).left;
		int aright = ((java_cup.runtime.Symbol)CUP$Sintactico_configuracion$stack.peek()).right;
		Objeto a = (Objeto)((java_cup.runtime.Symbol) CUP$Sintactico_configuracion$stack.peek()).value;
